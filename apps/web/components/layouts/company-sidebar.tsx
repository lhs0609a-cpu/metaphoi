  ...
  return (
    <aside className="hidden lg:flex lg:flex-col lg:w-64 lg:fixed lg:inset-y-0 border-r bg-background">
      ...
      <div className="p-4 border-b">
        <Link href="/company/dashboard" className="text-lg font-bold text-primary block">
          Metaphoi
        </Link>
        {member && (
          <p className="text-sm text-muted-foreground mt-1 truncate">{member.company_name}</p>
        )}
      </div>

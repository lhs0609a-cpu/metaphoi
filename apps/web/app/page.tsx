      ...
      <main className="min-h-screen bg-gradient-to-b from-background to-muted">
        ...
        <section className="container mx-auto px-4 py-20 text-center">
          <div className="inline-block mb-4 px-4 py-1.5 bg-primary/10 rounded-full">
            <span className="text-sm font-medium text-primary">AI 기반 종합 인재 평가</span>
          </div>
          ...
          <div className="mt-16 grid grid-cols-3 gap-8 max-w-xl mx-auto">
            <div>
              ...
              <div className="text-sm text-muted-foreground">검사 종류</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-primary">30</div>
              <div className="text-sm text-muted-foreground">능력치 분석</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-primary">AI</div>
              <div className="text-sm text-muted-foreground">맞춤 리포트</div>
            </div>
          </div>
        </section>

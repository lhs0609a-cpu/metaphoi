...
export const TEST_META: TestMeta[] = [
  ...
  { code: 'disc', name: 'DISC', description: '행동 유형 분석', questionCount: 28, category: 'personality', categoryLabel: '성격 검사', estimatedMinutes: 7, available: false },
  { code: 'enneagram', name: '에니어그램', description: '9가지 성격 유형', questionCount: 36, category: 'personality', categoryLabel: '성격 검사', estimatedMinutes: 8, available: false },
  ...
  { code: 'holland', name: 'Holland', description: '직업 흥미 유형', questionCount: 42, category: 'aptitude', categoryLabel: '적성/역량 검사', estimatedMinutes: 10, available: false },
  ...
  { code: 'saju', name: '사주', description: '생년월일시 분석', questionCount: 1, category: 'traditional', categoryLabel: '전통/특수 검사', estimatedMinutes: 1, available: false },
  { code: 'sasang', name: '사상체질', description: '체질 유형 분석', questionCount: 20, category: 'traditional', categoryLabel: '전통/특수 검사', estimatedMinutes: 5, available: false },
  ...
  { code: 'blood', name: '혈액형', description: '혈액형 성격 분석', questionCount: 5, category: 'traditional', categoryLabel: '전통/특수 검사', estimatedMinutes: 2, available: false },
];

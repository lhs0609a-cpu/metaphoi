      ...
      <section className="container mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 max-w-4xl mx-auto">
          {[
            ...
            <Card
              key={item.name}
              className={`text-center ${item.highlight ? 'border-primary bg-primary/5' : ''}`}
            >
              <CardContent className="pt-6 pb-4">
                <div className={`w-12 h-12 rounded-xl flex items-center justify-center mx-auto mb-3 ${item.highlight ? 'bg-primary/20 text-primary' : 'bg-muted text-muted-foreground'}`}>
                  {item.icon}
                </div>
